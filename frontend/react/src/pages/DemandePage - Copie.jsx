      ...
      <summary className="list-none cursor-pointer px-4 py-3">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 text-[12px] text-text-muted">
            <span>{campaign.preparation_status || '—'}</span>
      ...
      <div className="border-t border-border px-4 py-4 flex flex-col gap-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-[12px]">
          ...
          <div className="rounded-lg border border-border bg-surface px-3 py-2">
            ...
            <div className="mt-1 text-text">{campaign.statut || 'A cadrer'}</div>
...
function CampaignModal({ open, onClose, demande, campaign, onSaved }) {
  ...
  function handleSave() {
    ...
    const payload = {
      ...
      statut: campaign?.statut || 'A cadrer',
    }
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <FG label="Notes de cadrage" full>
            <textarea
              ...
              placeholder="Contraintes, livrables attendus, points de vigilance..."
            />
          </FG>
        </div>
