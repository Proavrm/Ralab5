"""
app/models/demande_rst.py — RaLab4
Modèle DemandeRst — données techniques complètes
"""
...
class DemandeRstRecord:
    ...
    filiale:                str = ""
    titulaire:              str = ""
    responsable_affaire:    str = ""
    statut_affaire:         str = ""
    date_ouverture_affaire: Optional[date] = None
    date_cloture_affaire:   Optional[date] = None
...
class DemandeRstCreateSchema(BaseModel):
    affaire_rst_id:         int            = Field(..., description="ID de l'affaire RST parente")
