...
export default function PreparationPage() {
    ...
    useEffect(() => {
        setForm({
            ...
            date_prevue: originalPrep.date_prevue || '',
            nb_points_prevus: originalPrep.nb_points_prevus || '',
            types_essais_prevus: originalPrep.types_essais_prevus || '',
            criteres_conformite: originalPrep.criteres_conformite || '',
            livrables_attendus: originalPrep.livrables_attendus || '',
                    ...
                    <div className="grid grid-cols-[minmax(0,1.55fr)_360px] gap-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <Field label="Date prévue">
                                        <Input
                                            ...
                                            onChange={(e) => setField('date_prevue', e.target.value)}
                                        />
                                    </Field>
                                    <Field label="Nb points prévus">
                                        <Input
                                            type="number"
                                            value={form.nb_points_prevus}
                                            onChange={(e) => setField('nb_points_prevus', e.target.value)}
                                            placeholder="Ex. 6"
                                        />
                                    </Field>
                                    <Field label="Types d'essais prévus" full>
                                        <Textarea
                                            value={form.types_essais_prevus}
                                            onChange={(value) => setField('types_essais_prevus', value)}
                                            rows={2}
                                            placeholder="PL, PANDA, prélèvements GNT, WE, CBR…"
                                        />
                                    </Field>
                                </div>
                            </Section>

                            <Section title="Critères et livrables">
                                <div className="grid grid-cols-2 gap-3">
                                    <Field label="Critères de conformité / acceptation" full>
                                        <Textarea
                                            value={form.criteres_conformite}
                                            onChange={(value) => setField('criteres_conformite', value)}
                                            rows={2}
                                            placeholder="EV2 ≥ 50 MPa, compacité ≥ 95% OPN, CCTP art. 3.2…"
                                        />
                                    </Field>
                                    <Field label="Livrables attendus" full>
                                        <Textarea
                                            value={form.livrables_attendus}
                                            onChange={(value) => setField('livrables_attendus', value)}
                                            rows={2}
                                            placeholder="PV d'essais, rapport de contrôle, note de synthèse…"
                                        />
                                    </Field>
                                    <Field label="Contraintes HSE / accès" full>
                                        <Textarea
                                            value={form.contraintes_hse}
                                            onChange={(value) => setField('contraintes_hse', value)}
                                            rows={2}
                                            placeholder="Balisage requis, coactivité, plan de prévention, accès nuit…"
                                        />
                                    </Field>
                                </div>
                            </Section>
                        ...
                        <div className="flex flex-col gap-4">
                            <Section title="Résumé">
                                ...
                                <InfoLine label="Nb points prévus" value={form.nb_points_prevus} />
                            ...
                            <Section title="Critères / Livrables">
                                <InfoLine label="Critères" value={form.criteres_conformite} />
                                <InfoLine label="Livrables" value={form.livrables_attendus} />
                                <InfoLine label="HSE / accès" value={form.contraintes_hse} />
                            </Section>
